...
lazy_static::lazy_static! {
    pub static ref AUTO_TRANSLATE: HashMap<(u32, u32), LocalisedText> = maplit::hashmap! {
        ...
        (61, 1) => LocalisedText {
            en: "nsheatheyourmainarm.",
            ja: "刀する",
            de: "tdenCharakterseineWaffeziehenoderwegstecken.",
            fr: "ner",
        },
        (61, 2) => LocalisedText {
            en: "haracter",
        ...
        (61, 5) => LocalisedText {
            en: "essuchasalliedsocietydailiesandlevequestallowanceallotment.",
            ja: "��かわるタイマー情報の一覧です。リーヴの受注権獲得までの時間や、友好部族デイリークエストの残り受注権の数などが確認できます。",
            de: "htenoderWartezeitfürverschiedeneInhalte,z.B.FreibriefeoderAufträgederFreundesvölkeran.",
            fr: "relativesàdiversélémentsdejeucommel'obtentiond'autorisationspourlesmandatsouencorelequotarestantdequêtesquotidiennesdespeuplesalliés.",
        },
        (61, 6) => LocalisedText {
            en: "ements",
            ja: "ーブメントリスト",
        ...
        (61, 7) => LocalisedText {
            en: "informationonitemspreviouslygathered,aswellasminingandlogginglocationscategorizedbyarea.",
            ja: "��ークラスが採掘、砕岩、伐採、草刈で得られるアイテムの一覧です。目的のアイテムを採集できるエリアの情報もここから確認できます。",
            de: "eineListederGegenständean,dieSammlerdurchAbbauen,Herausbrechen,AbholzenundAberntenbeschaffensollen.Außerdemwirdangezeigt,inwelchenGegendendieseGegenständezufindensind.",
            fr: "chedesinformationssurlesobjetsdéjàrécoltésainsiqueleslieuxderécolteclassésparzone.",
        },
        (61, 8) => LocalisedText {
            en: "alistofhuntingobjectivesforDisciplesofWarandMagic.Informationonmonsterhabitat,killsrecorded,andexperienceearnedisalsoavailable.",
            ja: "�ター・ソーサラークラスの討伐目標となるモンスターの一覧です。討伐対象モンスターの討伐数や主な生息地、獲得できる経験値報酬などを確認できます。",
            de: "ListederMonsteran,dieKriegerundMagiererlegensollen.Außerdemwirdangezeigt,inwelchenGegendendieMonsterzufindensindundwievielRoutinemanerhält.",
            fr: "listed'ennemisàvaincrepourlesclassesdecombattantsetdemages,desinformationssurl'habitatdesmonstres,lenombretué,etl'expériencegagnée.",
        },
        (61, 9) => LocalisedText {
            en: "craftinginterfacefromwhichyoucanselectitemstosynthesize.",
            ja: "タークラスが製作できるアイテムやレシピの一覧です。アイテムの製作が行えます。",
            de: "eigteineListederGegenständean,dieHandwerkerherstellensollensowiederenSyntheserezepte.HierkannstdudenSynthesevorgangstarten.",
            fr: "rel'interfaced'artisanatdepuislaquellevouspouvezsélectionnerdesobjetsàsynthétiser.",
        },
        (61, 10) => LocalisedText {
            en: "ventory",
            ja: "�持品",
        ...
        (61, 11) => LocalisedText {
            en: "Items",
            ja: "ベントアイテムリスト",
            de: "lüsselgegenstände",
            fr: "ets-clefs",
        },
        (61, 12) => LocalisedText {
            en: "playsalistofyourcurrentpartymembers.Fromthislistyoucanchangememberorder,andifyouareleader,kickotherplayersordissolvethepartyaltogether.",
            ja: "�バー",
            de: "neListedeinerGruppenmitgliederan.Dukannstz.B.dieGruppeverlassen,auflösenoderdieAnzeigereihenfolgeändern.",
            fr: "eunelistedevoséquipiersactuels.Àpartirdecetteliste,vouspouvezchangerl'ordredeséquipierset,sivousêteslechefd'équipe,exclured'autresjoueursoudissoudrel'équipe.",
        },
        (61, 13) => LocalisedText {
            en: "ysalistofplayersonyourfriendlist.Fromthislistyoucansend/tellmessagesorinviteplayerstoaparty.",
            ja: "ト管理",
            de: "ListederCharakterean,diedualsFreunderegistrierthast.FlüstereeinemFreundetwaszuoderladeeinenFreundaufdeinerWeltindeineGruppeein.",
            fr: "heunelistedesjoueursenregistrésdansvotrelisted'amis.Àpartirdecetteliste,vouspouvezleurenvoyerdesmurmuresetlesinviteràformeruneéquipe.",
        },
        (61, 14) => LocalisedText {
            en: "alistofplayersyouhaveaddedtoyourblacklist.Notonlywilltheircharactersandmessagesbehidden,buttheywillbeunabletotradewithyouorinviteyoutoparties.",
            ja: "��管理",
            de: "teineListederCharakterean,dieduaufdieSchwarzeListegesetzthast.SieunterliegenverschiedenenBeschränkungen,z.B.dasssowohldieCharaktereselbstalsauchvonihnengesendeteNachrichtendirnichtangezeigtwerden.WeiterhinkönnensienichtmitdirhandelnoderdichinihreGruppeeinladen.",
            fr: "lesjoueursprésentsdansvotrelistenoire.Lespersonnagesconcernésn'apparaissentplusenjeu,leursmessagessontcachésetilssontincapablesdevousinviteroud'échangeravecvous.",
        },
        (61, 15) => LocalisedText {
            en: "forotherplayersusingvariablessuchasname,class,level,andonlinestatus.",
            ja: "�チ",
            de: "SpielersuchekannstduunterverschiedenenKriteriennachanderenSpielercharakterensuchen.AußerdemkannstdudeinenOnline-StatusoderSuchkommentarändern.",
            fr: "chercherd'autresjoueursàl'aidedevariablescommelenom,laclasse,leniveauetl'étatenligne.",
        },
        (61, 16) => LocalisedText {
            en: "nsthemapofyourcurrentlocation.Mapscontaininformationonpartymembers,aetherytes,shops,guilds,andquestdestinations.Mapscanalsobezoomedinorout,orswappedwithregionorworldmaps.",
            ja: "��",
            de: "eigteineKartean,aufderdudiePositiondeinerGruppenmitgliederoderZielgebietedeinerAufträgenachsehenkannst.HändlerundwichtigeOrientierungspunktesindebenfallseingetragen.DukannstauchzoomenoderKartenandererRegionenanzeigen.",
            fr: "uvrelacartedevotreemplacementactuel.Vousytrouverezdesinformationssurleséquipiers,leséthérites,leséchoppes,lesguildesetladestinationdesquêtes.Vouspouvezconsulterlesautreszones,effectuerunzoomavantouarrière,etpasseràlacartedelarégionoudumonde.",
        },
        (61, 17) => LocalisedText {
            en: "splaysalistofavailableemotecommandswhichcanbeexecutedfromthelist,orsettoyourhotbar.",
            ja: "トアクション",
            de: "igteineListederEmotesan.Siehelfendir,mitanderenSpielernzuinteragierenundverleihendemSpielAtmosphäre.DukannstsieauchimKommandomenüanlegen.",
            fr: "ficheunelistedesemotesdisponibles.Vouspouvezleseffectuerdepuislalisteoulesajouteràvotrebarrederaccourcis.",
        },
        (61, 18) => LocalisedText {
            en: "targetswithvariousdifferentsignstomakethemeasierforpartyandalliancememberstodistinguish.",
            ja: "��トマーカー",
            de: "en",
            fr: "metdemarquerdiversesciblespourquelesmembresd'uneéquipeoud'unealliancelesdiscernentplusfacilement.",
        },
        (61, 19) => LocalisedText {
            en: "ystem-relatedsettingssuchasgraphics,sound,functionality,andmore.",
            ja: "��ウンドやグラフィックなどのシステム項目を、プレイヤーの環境にあわせて自由に設定できます。",
            de: "stemeinstellungenkannstduKonfigurationenvonSoundundGrafikvornehmenoderdieTastenbelegungändern.",
            fr: "lafenêtredesparamètressystèmecommelesoptionsvidéo,audio,lesfonctionnalitésdejeuàlamanette,etc.",
        },
        (61, 20) => LocalisedText {
            en: "functionstoyourkeyboardtobettersuityourplaystyle.",
            ja: "々な操作やショートカット機能に割り当てるキーを自由に設定できます。",
            de: "udieTastenmitverschiedenstenFunktionenbelegen.",
            fr: "etd'assignerdiversesfonctionsàdestouchesdevotreclavierselonvotrestyledejeu.",
        },
        (61, 21) => LocalisedText {
            en: "lti-stepmacrostoexecutecomplexcommandswithasinglebuttonpress.Macroscanbeassignediconsandsettoyourhotbarforeasyaccess.",
            ja: "�マンドを自由に組み合わせてマクロの作成が行えます。マクロはキャラクター専用、および他のキャラクターと共通で作成できます。作成したマクロはホットバーへの登録ができます。テキストコマンドの一覧が確認できます。",
            de: "osfüreinzelneoderalleCharaktereerstellen,umwiederkehrendekomplexeAktionenmiteinemeinzigenKlickausführenzukönnen,undimKommandomenüanlegen.DieverfügbarenTextbefehlewerdenineinerListeangezeigt.",
            fr: "cros,pourlepersonnageactueloupourtous,afindelancerdescommandescomplexesd'unsimplebouton.Vouspouvezleurassignerdesiconesetlesplacerdansvotrebarrederaccourcis.Unebibliothèquedescommandestexteestégalementdisponible.",
        },
        (61, 22) => LocalisedText {
            en: "size,anddisplaystatusofalluser-interfacecomponentsandsavethemtotemplates.",
            ja: "に常時表示されるウィンドウ（HUD）の表示位置・拡縮・表示（非表示）の変更や、保存したレイアウトの切り替えが行えます。",
            de: "ion,GrößeundDarstellungvonAnzeigefensternundanderenUI-Elementenändern.",
            fr: "age,l'emplacementetlatailledetouslescomposantsdel'interfaceutilisateur,etdesauvegarderplusieursconfigurations.",
        },
        (61, 23) => LocalisedText {
            en: "tothetitlescreen.",
            ja: "�アウトしてタイトル画面に戻ります。",
            de: "dbringtdichzumTitelbildschirmzurück.",
            fr: "éconnecteretretourneràl'écrantitre.",
        },
        (61, 24) => LocalisedText {
            en: "thegame.",
            ja: "��グアウトしてゲームを終了します。",
            de: "usundbeendetdasSpiel.",
            fr: "edéconnecteretquitterlejeu.",
        },
        (61, 25) => LocalisedText {
            en: "edinyourArmouryChest.Allgearobtainedisautomaticallymovedtothechestandsortedbytype.Fromhereitcanbeequipped,repaired,orreturnedtoyourinventory.",
            ja: "��した装備品が収納されています。装備品は部位ごとに整理され、装備や確認ができます。",
            de: "ungsgegenständebeimErwerbautomatischverstaut.SiesindnachKörperteilengeordnetundkönnenjederzeitangelegtwerden.",
            fr: "ngédansvotrearsenal.Toutl'équipementobtenuyestautomatiquementplacéetclassépartype.Delà,vouspouvezvousenéquiper,leréparerouledéplacerversvotreinventaire.",
        },
        (61, 27) => LocalisedText {
            en: "pany",
            ja: "�カンパニー",
        ...
        (61, 28) => LocalisedText {
            en: "Displaysalistofalllinkshellmembersforallyourlinkshells.",
            ja: "�ェル",
            de: "s",
            fr: "Afficheunelistedetouslesmembresdetoutesvoslinkshells.",
        },
        (61, 29) => LocalisedText {
            en: "ormationonyourpreviouscatches,aswellasfishingholelocationscategorizedbyarea.",
            ja: "�スが釣った魚や釣り場を記した一覧です。様々な地域で釣りをすることで記載内容が追加されていきます。",
            de: "önnenFischerihrenFangunddieAngelstelleneinerRegioneinsehen.",
            fr: "desinformationssurvosprisesprécédentesainsiquel'emplacementdeslieuxdepêcheclassésparzone.",
        },
        (61, 30) => LocalisedText {
            en: "lpreviouslyviewedactivehelptutorials.",
            ja: "追加されたHowToの一覧が確認できます。",
            de: "stederbishergesehenenHilfstextean.",
            fr: "torielspourlesfonctionsdejeudisponibles.",
        },
        (61, 31) => LocalisedText {
            en: "alistofnearbyquestsanddutiescurrentlyavailable.",
            ja: "��",
            de: "isteempfohlenerAufträge,FATEsundandererInhalteinderUmgebungan.",
            fr: "nelistedesquêtes,missionsouALÉAaccessiblesauniveaudevotrepersonnageetactuellementdisponiblesdanslesenvirons.",
        },
        (61, 32) => LocalisedText {
            en: "Searchforanswerstofrequentlyaskedquestions,reportissues,andconfirmmessagesfromtheFINALFANTASYXIVsupportteam.",
            ja: "ニュース",
            de: "/Infos",
            fr: "ide",
        },
        (61, 33) => LocalisedText {
            en: "aseddutiessuchasinstancedraidsandguildhestswithouthavingtogatherapartyyourself.",
            ja: "ンやギルドオーダーなどのコンテンツの内容や参加条件の確認、参加申請できる一覧です。自動的に編成されたパーティ、または任意の編成で挑戦する事ができます。",
            de: "nglicheSpielinhaltewieDungeonsundGildengeheiße,jeweilsmiteinerkurzenBeschreibungunddenTeilnahmebedingungen.AndenInhaltenkannstdudirektausderInhaltssucheherausteilnehmen,entwedermiteinerbestehendenodereinerzufälligzusammengestelltenGruppe.",
            fr: "deconsulterladescriptionetlescritèresdesmissionsinstanciées,commelesdonjonsoulesopérationsdeguilde,etdes'enregistrerenvued'yparticiper.Uneéquipeavecd'autresjoueursseraforméepargroupementautomatiquesivousêtesensoloouennombreinsuffisantdeparticipants.",
        },
        (61, 34) => LocalisedText {
            en: "settingssuchascameratype,targetingfunctionality,hotbarcommands,andchatlogpreferences.",
            ja: "�ユーザーインターフェース設定、ホットバー設定、チャットログ設定など、キャラクターに関わるコンフィグ項目を自由に設定できます。",
            de: "reicheEinstellungenvornehmen,diedeinenCharakterbetreffen(z.B.Steuerung,KommandomenüundChatlog).",
            fr: "ermetdechangerlesparamètresliésaupersonnagecommeletypedemaniement,l'interface,lesbarres/croixderaccourcisoulafenêtredelog.",
        },
        (61, 35) => LocalisedText {
            en: "Teleport",
            ja: "テレポ",
        ...
        (61, 41) => LocalisedText {
            en: "vecaught,whereyoucaughtthem,aswellasyourpersonalrecords.",
            ja: "��ての詳細を記した一覧です。魚を釣ることで記載内容が追加されていきます。",
            de: "tüberangelbareBeutetierefürFischer.",
            fr: "pêche,oùsontnotéslesdétailsdespoissonsquevousavezattrapés.Lecontenuchangeàmesurequevouspêchezplusdepoissons.",
        },
        (61, 42) => LocalisedText {
            en: "companions,includinglevel,class,andavailableactions.",
            ja: "用できるアクションなどを確認できます。バディのスキルの修得もここから行えます。",
            de: "treiterwiedieKommandosundKunststücke,dieerbeherrscht.",
            fr: "�partirdelaquellevouspouvezconsulterentreautressonétat,letempsqu'illuiresteàvoscôtés,ousesactions.",
        },
        (61, 56) => LocalisedText {
            en: "uchasrankandperformancerecords,andsetPvPactionstoyourhotbars.",
            ja: "��や、PvPアクションの確認やホットバーへの登録が行えます。",
            de: "PvP-Kommandoseinrichten.",
            fr: "scontred'autresjoueurs,deconsulterdesactionsspécifiquesauJcJetdelesplacerdanslabarrederaccourcisJcJ.",
        },
        (61, 57) => LocalisedText {
            en: "hespecifiedconditions.",
            ja: "�たパーティメンバー募集が行えます。",
            de: "echenddeinenZielenoderdergewünschtenRolledurch.",
            fr: "ourformeruneéquipeenspécifiantcertainesconditionscommelesrôlesouletypedemission.",
        },
        (61, 58) => LocalisedText {
            en: "memberstoadestination.",
            ja: "ティやアライアンスで共有可能な目印を設置できます。",
            de: "nurfürGruppen-undAllianzmitgliedersichtbarsind.",
            fr: "visiblespartouslesmembresd'équipeoud'alliance.",
        },
        (61, 59) => LocalisedText {
            en: "alliancemembers.",
            ja: "��メンバー全員に準備確認が行えます。",
            de: "ianzmitglieder,obsiebereitsind.",
            fr: "ipierset/ouauxmembresdel'allianceafindes'assurerqu'ilssontprêtsàagir.",
        },
        (61, 60) => LocalisedText {
            en: "undertake.Informationonprogressandrewardsisalsoavailable.Progressineachcategoryisreseteveryat(Earthtime).",
            ja: "�略項目の一覧です。攻略項目の達成状況や、得られる報酬などをここで確認できます。項目の達成状況は、（地球時間）毎週曜日の時にリセットされます。",
            de: "erledigendenHerausforderungenunddieVergütungdafüran.DerbereitserreichteFortschrittwirdjedenum:00Uhr(Erdenzeit)zurückgesetzt.",
            fr: "ccomplissantdesobjectifsdiversliésàdesélémentsdejeu.Lalimitedetempsestréinitialiséetouslesàh(tempsréel).",
        },
        (61, 61) => LocalisedText {
            en: "uhaveacquired.",
            ja: "覧です。マウントの閲覧や呼び出しなどが行えます。",
            de: "Dukannstsievonhierausauchherbeirufen.",
            fr: "obtenuesetd'enappelerune.",
        },
        (61, 62) => LocalisedText {
            en: "ouhavecollected.",
            ja: "��です。ミニオンの閲覧や呼び出しなどが行えます。",
            de: "Dukannstsievonhierausauchherbeirufen.",
            fr: "obtenuesetd'enappelerune.",
        },
        (61, 65) => LocalisedText {
            en: "dSaucer,includingMGPinpossession,Cactpotdrawtimes,TripleTriadtournamentresults,personaldeckmakeup,LordofVerminionhotbarandDomanmahjongsettings,andracechocobostatus.",
            ja: "��報の確認ができます。競走羽のパラメータや血統情報の確認・装備変更、トリプルトライアドのデッキ編集、LoVMのミニオンホットバー編集、ドマ式麻雀の設定などが行えます。",
            de: "remMGPindeinemBesitz,Glückskaktor-Ziehungen,TripleTriad-Turnierstände,Kartendecks,Trabanten-KommandomenüundStatusdeinesRenn-Chocobos.",
            fr: "tivesauGoldSaucer.Permetentreautresdemodifierl'équipementdeschocobosdecourse,degérervosjeuxdeTripleTriade,d'éditervosbarresCdMetdechangerlesparamètresdumahjongdomien.",
        },
        (61, 67) => LocalisedText {
            en: "nts.",
            ja: "覧です。様々な地域で交感をすることで記載内容が追加されていきます。",
            de: "dätherquellenan.",
            fr: "lsvousvousêtesharmonisé.",
        },
        (61, 68) => LocalisedText {
            en: "ASYXIVwebsite,theLodestone.",
            ja: "��イヤーズサイト「Lodestone」内の「プレイガイド」にアクセスするためのメニューを開きます。",
            de: "ffiziellenSpielerwebsite,demLodestone,indeinemBrowseranzuzeigen.",
            fr: "sdejeusurTheLodestone,lesiteofficieldesjoueursdeFFXIV.",
        },
        (61, 69) => LocalisedText {
            en: ".",
            ja: "することができる楽曲の一覧です。楽譜を手に入れることで記載内容が追加されていきます。",
            de: "BeispielinGästezimmernabspielenkannst.MitjederNotenrolle,dieduerhältst,kommteinneuerTitelhinzu.",
            fr: "avezobtenulesrouleauxetqu'ilestpossibledejoueravecl'orchestrion.",
        },
        (61, 70) => LocalisedText {
            en: "ccesstotheirregimenoftrainingexercisesdesignedtoteachnewDisciplesofWarandMagicthebasicsofcombatfortank,healer,andDPSroles.",
            ja: "�ール（TANK、HEALER、DPS）の基本的な戦い方を訓練することができます。現在のロールや、訓練の進捗に応じて、適切な訓練内容が提示されます。",
            de: "enÜbungendiegrundlegendenKampfstrategienalsVerteidiger,AngreiferundHeilerlernen.",
            fr: "lesdifférentstypesdeclassesdecombattantetdemage(tank/soigneur/DPS).L'entraînementproposédépenddevotreclasseoujobactueletdevotreavancement.",
        },
        (61, 72) => LocalisedText {
            en: "settingsallowforsoloplayersorpartiesundertheminimummemberrequirementstobematchedwithplayerswiththesamegoals.",
            ja: "�戦できます。規定人数未満でも条件を詳細に設定することで、同じ目的を持ったプレイヤーたちと自動的にパーティが編成され、コンテンツに参加できます。",
            de: "eilnehmen.AuchunterdererforderlichenGruppengrößekannstduautomatischineineGruppemitgleichgesinntenSpielerngebrachtwerden.",
            fr: "iciperauxmissionsàdifficultéélevéelesplusrécentes.Sivousêtesensoloouennombreinsuffisantdeparticipants,uneéquipeavecd'autresjoueursayantsélectionnélesmêmescritèresseraforméepargroupementautomatique.",
        },
        (61, 73) => LocalisedText {
            en: "ndalliancemembers.",
            ja: "秒数で設定し、自分やパーティメンバー、アライアンスメンバーに対して表示できます。",
            de: "oderAllianzmitgliederndenKampfbeginnsignalisiert.",
            fr: "réepeutêtrechoisie,afindedonnerlesignalducombatauxmembresdel'équipeoudel'alliance.",
        },
        (61, 74) => LocalisedText {
            en: "rtied.Playersonthelistcanbeaddedtoyourfriendlist.",
            ja: "��キャラクターの一覧です。一覧に表示されているキャラクターにフレンド申請を行えます。",
            de: "terZeitineinerGruppegespielthast.DukannstdieseCharaktereaufdeineFreundeslistesetzen.",
            fr: "vezdernièrementforméuneéquipe.Ilestpossibled'envoyerunerequêted'amiàchacund'entreeux.",
        },
        (61, 76) => LocalisedText {
            en: "�",
            ja: "きます。リプレイの記録設定もここから行います。",
            de: "Datenaufzeichnungeinoderaus.",
            fr: "issionsetdeparamétrerleurvisionnage.",
        },
        (61, 77) => LocalisedText {
            en: "Fromthislist,itemscanbetransferredtoyourinventory,orthatofaretainer.Cannotbeaccessedwhileparticipatingininstancedduties.",
            ja: "��り引き出したりできます。（コンテンツ内では利用できません）",
            de: "ausdeinemInventaroderausdemGehilfeninventarindieSatteltaschelegen.(KannnichtininstanziiertenInhaltenverwendetwerden.)",
            fr: "lesdéplacerentrelasacochechocoboetvotreinventaireouceluidesservants.(Inaccessibleencoursdemission)",
        },
        (61, 78) => LocalisedText {
            en: "ordReadyCheck",
            ja: "�。",
            de: "Bereitschaftsanfrage(Rückblende)",
            fr: "ionsrelativesàl'équipeJcJ.",
        },
        (61, 79) => LocalisedText {
            en: "ersbeforerecordingaduty.Canonlybeusedwhileonarecordableduty.",
            ja: "のレディチェックと、戦闘開始カウントを行います。記録が可能なコンテンツでのみ利用できます。",
            de: "siebereitsind.DieseBereitschaftsanfragewirdbenutzt,wenneinInhaltfürRückblendenaufgenommenwerdensoll.",
            fr: "pteàreboursavantd'enregistrerunemissionenvued'unfuturvisionnage.",
        },
        (61, 80) => LocalisedText {
            en: "kshellstatus,andinviteplayerstojoincross-worldparties.",
            ja: "��を作成したり、所属するクロスワールドリンクシェルの確認ができます。他ワールドメンバーに対してクロスワールドパーティ勧誘を行えます。",
            de: "emduangehörst.DukannstaucheineneigenenWelten-Kontaktkreiserstellenundverwalten.",
            fr: "lterlalistedesesmembres.Ilestd'ailleurspossibled'invitercesjoueursàrejoindreuneéquipeinter-Monde.",
        },
        (61, 81) => LocalisedText {
            en: "beaddedtoandremovedfromyourActiveActions.",
            ja: "�て使える青魔法の選択を行います。",
            de: "ernteZauberkönnenzudenaktivenKommandoshinzugefügtundwiederentferntwerden.",
            fr: "quevousavezdébloquées,maisaussid'enajouteroud'enretireràvotresetactif.",
        },
        (61, 82) => LocalisedText {
            en: ".",
            ja: "を攻略できます。",
            de: "s.",
            fr: "articiperàundonjon.",
        },
        (61, 84) => LocalisedText {
            en: "ankandnumberofFATEscompletedwiththehighestratingpossible.",
            ja: "��当地域のF.A.T.E.で最高評価を獲得すると記載内容が追加されていきます。",
            de: "rreichtenBewertungen.",
            fr: "ourlesconsulter,ilfautnéanmoinsréussirunALÉAaveclemeilleurscorepossibledanslazoneconcernée.",
        },
        (61, 85) => LocalisedText {
            en: "6�FellowshipFinder",
            ja: "ローシップの情報を確認できます。",
            de: "uswählen,indemduMitgliedbist.",
            fr: "formationsquileursontrelatives,etvouspermetd'encréervous-même.",
        },
        (61, 86) => LocalisedText {
            en: "them.",
            ja: "��を見ることができます。一覧からフェローシップに参加することができます。",
            de: "erdieListeinderZirkelsuchekannstdudiesenZirkelnauchbeitreten.",
            fr: "ellementetvouspermetdelesrejoindre.",
        },
        (61, 90) => LocalisedText {
            en: "",
            ja: "�。",
        ...
        (61, 94) => LocalisedText {
            en: "ntriesforstoryelementsdiscoveredinvariantdungeons.",
            ja: "探索をするための設定や参加申請ができます。ヴァリアントダンジョンで発見した物語をまとめて読むこともできます。",
            de: "llungenanpassen.DukannstdirauchEinträgezuderGeschichteansehen,diedubeiderErkundungunsteterGewölbeenthüllst.",
            fr: "�cial,demodifiercertainsparamètresdeparticipationetd'ouvrirlejournald'explorationdesdonjonsàembranchements.",
        },
        (61, 96) => LocalisedText {
            en: "aracterswillbehidden.",
            ja: "�す。登録されたキャラクターの発言は見えなくなります。",
            de: "htenvonstummgeschaltetenCharakterenwerdennichtangezeigt.",
            fr: "gesconcernéssontcachés.",
        },
        (61, 97) => LocalisedText {
            en: "ove,oredittermstobefilteredfromthechatlog.",
            ja: "ら新規登録や編集・削除を行います。",
            de: "undbestehendeWörterbearbeitetodergelöschtwerden.",
            fr: "desmotsdéterminés.",
        },
